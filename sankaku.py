...
l = tk.Label(win, text='开始日期：',font=('pingfang', 12))
l.place(x=80,y=30,anchor='s')

n = tk.Label(win, text='结束日期：',font=('pingfang', 12))
n.place(x=260,y=30,anchor='s')
...
d = tk.Button(win, text='第一步', font=('pingfang', 12), width=12, height=2, command=first)
d.place(x=80,y=180,anchor='s')

e = tk.Button(win, text='第二步', font=('pingfang', 12), width=12, height=2, command=second)
e.place(x=200,y=180,anchor='s')

f = tk.Button(win, text='第三步', font=('pingfang', 12), width=12, height=2, command=third)
f.place(x=320,y=180,anchor='s')
